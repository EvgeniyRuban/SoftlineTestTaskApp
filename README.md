...
Стажер C# (Directum RX)
Для отклика на эту вакансию необходимо ответить на вопрос работодателя.

Уважаемый соискатель,

для прохождения дальнейших этапов необходимо сделать тестовое задание.

Срок выполнения до 14.02 включительно (чем раньше, тем больше шансов попасть на оплачиваемую стажировку)
